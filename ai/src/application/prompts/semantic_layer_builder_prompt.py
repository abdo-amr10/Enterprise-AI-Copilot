...
For example, a description derived from table and column names may be added as semantic enrichment.

However, do not introduce a business concept such as a customer segment, customer category, or business rule unless the provided sources contain evidence supporting that concept.

## 4. Source and Generated Information
